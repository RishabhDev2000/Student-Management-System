...
mongoose.connect('mongodb+srv://root:root@cluster0.wsigdmq.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, function (err) {
    console.log('Connected to MongoDB Database');
});
router.post('/register', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var newuser, savedstudent, error_1;
